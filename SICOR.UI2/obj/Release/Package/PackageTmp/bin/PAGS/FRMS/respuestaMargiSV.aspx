                ...
                <div class="grid condensed">
                    ...
                    <div class="row cells4">
                        ...
                        <div class="cell colspan2">
					        ...
					        <div class="input-control text place-right">
                                <span class="mif-calendar prepend-icon"></span>
						        <input type='text' id='NOTARECIBFEC' name='NOTARECIBFEC' class='notNull' readonly="readonly" />
					        </div>
                        </div>
                    </div>
                    <div class="row cells4">
                        ...
                        <div class="cell colspan2">
					        ...
					        <div class="input-control text place-right">
						        ...
						        <input type='text' id='NOTARECIBHORA' name='NOTARECIBHORA' class='notNull' readonly="readonly" />
					        </div>
                        </div>
                    </div>
                    <div class="row cells4">
