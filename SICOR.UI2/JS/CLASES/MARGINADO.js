...
function mensajeEX() {
    ...
    if (datCorres.CONTNOMBRE_REMITE != "" && datCorres.CONTINST_REMITE != ""
...
function cargarListMargi(div, edit) {
    ...
    if (edit) {
        ...
        datMargi = $("#corres_" + datGenM.CORRESID_CONTESTA).data("datos").datmargi;
        datGen = $("#corres_" + datGenM.CORRESID_CONTESTA).data("datos").datCorres;
