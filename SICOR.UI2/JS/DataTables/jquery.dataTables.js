	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Items por pagina: _MENU_",
				"sZeroRecords": "No hay coincidencias",
				"sEmptyTable": "No hay registros",
				"sLoadingRecords": "Cargando...",
				"sInfo": "Mostrando _START_ a _END_ de _TOTAL_ Items",
				"sInfoEmpty": "Mostrando 0 a 0 de 0 Items",
			 ...
			 */
			this.aLengthMenu = [ 10, 15, 20,50,100 ];
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="Filtro..." /><div class="srch"></div>';
