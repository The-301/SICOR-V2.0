...
{
    /// <summary>
    /// MultipleFileUpload user control.
    /// </summary>
    public partial class MultipleFileUpload : System.Web.UI.UserControl
    {
        ...
        /// <summary>
        /// Set this option to false to disable filenames edition for files available for uploads.
        /// Defaults to true.
        /// </summary>
        public bool EditableFileNames { get { return (bool)(ViewState["EditableFileNames"] ?? true) && !EnableChunkedUploads; } set { ViewState["EditableFileNames"] = value; } }
