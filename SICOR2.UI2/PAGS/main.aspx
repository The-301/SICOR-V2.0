<%@ Page Title="" Language="C#" MasterPageFile="~/PAGS/Site1.Master" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="SICOR2.UI2.PAGS.main" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="user-profile-area">
            <div class="task-manager">bandeja de Entrada</div>
            <div class="side-wrapper">
                <div class="user-profile">
                    <img src="https://assets.codepen.io/3364143/Screen+Shot+2020-08-01+at+12.24.16.png" alt="" class="user-photo">
                    <div class="user-name">demo.gp8</div>
                    <div class="user-mail">demo@economia.sv</div>
                </div>
